...
public class TestEventListenerWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegVar("onAct", get_onAct, set_onAct);
	...
	static int get_onAct(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			TestEventListener obj = (TestEventListener)o;
			System.Action ret = obj.onAct;
			ToLua.Push(L, ret);
			return 1;
		}
		catch(Exception e)
		{
			return LuaDLL.toluaL_exception(L, e, o, "attempt to index onAct on a nil value");
		}
	}
